...
if __name__ == '__main__':
    ...
    # hive> set hive.metastore.warehouse.dir;
    # hive.metastore.warehouse.dir=/user/itv020752/warehouse
    ...
    # after loading the data from local file system into a hive table, the data will still be there in the local file system.
    # but if we are loading the data from hdfs to a hive table, then the data will be moved from hdfs to hive table.
