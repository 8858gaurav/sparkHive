...
spark.sql("""
CREATE TABLE itv020752_db.table_democ (
    order_id STRING, 
    order_date STRING, 
    customer_id STRING, 
    order_status STRING
...
USING CSV 
OPTIONS
(path '/user/itv020752/data/data2',
header 'true')
""")
...
spark.sql("describe extended table_democ").show(truncate = False)
# +----------------------------+---------------------------------------------------------+-------+
...
# |Table                       |table_democ                                              |       |
# |Owner                       |itv020752                                                |       |
# |Created Time                |Thu Nov 13 12:07:11 EST 2025                             |       |
# |Last Access                 |UNKNOWN                                                  |       |
# |Created By                  |Spark 3.1.2                                              |       |
# |Type                        |EXTERNAL                                                 |       |
# |Provider                    |CSV                                                      |       |
# |Location                    |hdfs://m01.itversity.com:9000/user/itv020752/data/data2  |       |
...
spark.sql("select count(*) from table_democ").show()
# +--------+
# |count(1)|
# +--------+
# |       0|
...
# !hadoop fs -ls data/data2/
# No file has been placed inside this folder

# After placing the file manually to data/data1 folder
# !hadoop fs -put /home/itv020752/Data/Datasets/orders.csv data/data2
# !hadoop fs -ls data/data2
# Found 1 items
...
spark.sql("refresh table table_democ")
spark.sql("select count(*) from table_democ").show()
# +--------+
# |count(1)|
# +--------+
...
# !hadoop fs -put /home/itv020752/Data/Datasets/orders_with_header.csv data/data2
# !hadoop fs -ls data/data2
# Found 2 items
# -rw-r--r--   3 itv020752 supergroup       4333 2025-11-13 12:10 data/data2/orders.csv
...
# !hadoop fs -put /home/itv020752/Data/Datasets/orders_without_header.csv data/data2
# !hadoop fs -ls data/data2
# Found 3 items
# -rw-r--r--   3 itv020752 supergroup       4333 2025-11-13 12:10 data/data2/orders.csv
# -rw-r--r--   3 itv020752 supergroup         82 2025-11-13 12:14 data/data2/orders_with_header.csv
# -rw-r--r--   3 itv020752 supergroup         37 2025-11-13 12:17 data/data2/orders_without_header.csv
...
# !hadoop fs -cat data/data2/orders_with_header.csv
# order_id,order_date,customer_id,order_status
# 1,2013-07-25 00:00:00.0,11599,CLOSED

# !hadoop fs -cat data/data2/orders_without_header.csv
# 1,2013-07-25 00:00:00.0,11599,CLOSED


# !hadoop fs -cat data/data2/orders.csv | head 
# order_id,order_date,customer_id,order_status
# 1,2013-07-25 00:00:00.0,11599,CLOSED
...
spark.sql("select * from table_democ where order_id = '1'").show()
...
# palcing a new file with header columns
# !hadoop fs -cat data/data2/orders_with_header2.csv
# order_id,order_date,customer_id,order_status
# 1,2013-07-25 00:00:00.0,11599,CLOSED

# !hadoop fs -put /home/itv020752/Data/Datasets/orders_with_header2.csv data/data2
# !hadoop fs -ls data/data2
# Found 4 items
# -rw-r--r--   3 itv020752 supergroup       4333 2025-11-13 12:10 data/data2/orders.csv
# -rw-r--r--   3 itv020752 supergroup         82 2025-11-13 12:14 data/data2/orders_with_header.csv
# -rw-r--r--   3 itv020752 supergroup         82 2025-11-13 12:23 data/data2/orders_with_header2.csv
# -rw-r--r--   3 itv020752 supergroup         37 2025-11-13 12:17 data/data2/orders_without_header.csv
