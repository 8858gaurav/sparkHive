...
if __name__ == '__main__':
    ...
    spark.sql("select * from misgaurav_hive_new.table1").show()
       ...
       # will this data still be there in the above path after loading the data into a hive table - data/new_orders2 - No, it will not be there.
       # why? - since this data is already stored in hdfs with RF = 3, after creating a hive table, again this data will be stored in hdfs (/user/itv020752/warehouse) with RF = 3.
       # for the same data, it will be stored in hdfs with RF = 6, hence it will be a waste of space.
       # the data will be automatically taken from this path: data

       # [itv020752@g01 ~]$ hadoop fs -ls data
       # Found 5 items
       ...
       # our data will be only present in warehouse directory, not in the data directory.
       # [itv020752@g01 ~]$ hadoop fs -ls /user/itv020752/warehouse/misgaurav_hive_new.db
       # Found 2 items
       # drwxr-xr-x   - itv020752 supergroup          0 2025-08-14 05:28 /user/itv020752/warehouse/misgaurav_hive_new.db/table1
       # drwxr-xr-x   - itv020752 supergroup          0 2025-08-13 07:16 /user/itv020752/warehouse/misgaurav_hive_new.db/table2
